      ...
      d3.select(accordion_panel_id).attr("y", function(d, i){ return panel_y - accordion_panel_height; });
        ...
        if(chart_class_name[i] != "")
        {
          d3.selectAll(chart_class_name[i]).select("rect").attr("transform","translate(0,"+chart_y[i]+")") ;
      	  ...
      	  d3.selectAll(chart_class_name[i]).select("#yaxis").attr("transform","translate("+1051+","+yaxis+")") ;
      	}
...
switch(occupationGroup.click)
	...
	for (var i = 0; i < 117; i++) {
		...
		if (i == maini) {
			...
			.style("fill","red")
			.attr("y", function(d) {
				   		return chart_base_y+(accordion_bar_height+5)*2 ;
				   })
			.attr("height", function(d) {
				   		return 0;
				   })
		...
		if (i == maini) {
			...
			.style("fill","red")
			.attr("y", function(d) {
				   		return chart_base_y+(accordion_bar_height+5)*3 ;
				   })
			.attr("height", function(d) {
				   		return 0;
				   })
		...
		if (i <maini) {
			...
			.attr("y", function(d) {
				   		if(d<0) return chart_base_y+(accordion_bar_height+5)*4;
		...
		if (i == maini) {
			...
			.style("fill","red")
			.attr("y", function(d) {
				   		return chart_base_y+(accordion_bar_height+5)*4 ;
				   })
			.attr("height", function(d) {
				   		return 0;
				   })
		...
		if (i <maini) {
			...
			.attr("y", function(d) {
				   		if(d<0) return chart_base_y+(accordion_bar_height+5)*5;
		...
		if (i == maini) {
			...
			.style("fill","red")
			.attr("y", function(d) {
				   		return chart_base_y+(accordion_bar_height+5)*5 ;
				   })
			.attr("height", function(d) {
				   		return 0;
				   })
		...
		if (i <maini) {
			...
			.attr("y", function(d) {
				   		if(d<0) return chart_base_y+(accordion_bar_height+5)*6;
		...
		if (i == maini) {
			...
			.style("fill","red")
			.attr("y", function(d) {
				   		return chart_base_y+(accordion_bar_height+5)*6 ;
				   })
			.attr("height", function(d) {
				   		return 0;
				   })
		...
		if (i <maini) {
			...
			.attr("y", function(d) {
				   		if(d<0) return chart_base_y+(accordion_bar_height+5)*7;
		...
		if (i == maini) {
			...
			.style("fill","red")
			.attr("y", function(d) {
				   		return chart_base_y+(accordion_bar_height+5)*7 ;
				   })
			.attr("height", function(d) {
				   		return 0;
				   })
		...
		if (i <maini) {
			...
			.attr("y", function(d) {
				   		if(d<0) return chart_base_y+(accordion_bar_height+5)*8;
		...
		if (i == maini) {
			...
			.style("fill","red")
			.attr("y", function(d) {
				   		return chart_base_y+(accordion_bar_height+5)*8 ;
				   })
			.attr("height", function(d) {
				   		return 0;
				   })
	...
	if(college.click!='?')
	{
		...
		if (i%108 <= max&& min <= i%108) {
			...
			.attr("height", function(d) {
            			...
            			else if(i>=108*3&&i<108*4) return (d.salary25-d.salary10)* 0.0015;
				   });
			}
