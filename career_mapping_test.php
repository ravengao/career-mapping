...
<head>
  ...
  <script src="career-mapping_beta.js"></script>
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  $(window).bind('scroll', function () {
      d3.select("#centralChart").attr("transform","translate(0,"+$(window).scrollTop() +")");
...
//major Salary
 ...
 //major Salary
  ...
  majorSalarybar.append("rect")
      ...
      .append("title")
      .text(function(d,i) {
      if(i<Salarybarlength)return occupationautomation.name[i]+":"+d.salary50;
      });
  ...
  var GPA_relevantY = accordion_bar_y+30;
  ...
  var MSalary_relevantY = accordion_bar_y + 63;

  var SATbar = leftSideCharts.selectAll(".SATbar")
                          .data(barRange)
                          .enter().append("g")
                          .attr("class","SATbar");

  chart_name.push("SAT");
  chart_class_name.push(".SATbar");
  ...
  d3.select(".suboccupationSalarybar").append("g");
    ...
    for (var i = 0; i < occupationGroup.name.length; i++) {
      ...
      var OA = rightSideCharts.selectAll(".OA")
        ...
        tmpy=chart_base_y-d3.max(occupationautomation.number);
        var y = d3.scaleLinear()
...
//OG
      var OG = rightSideCharts.selectAll(".OG")
        ...
        OG.append("text")
         ...
         // zzcharttext_y.push(0);
         // axis for OG
        tmpy=chart_base_y+(accordion_bar_height+5)*1-40-d3.max(occupationglobalization.number)*0.5;
        var y = d3.scaleLinear()
...
//Create suboccupationglobalization element
      ...
      var OSG = rightSideCharts.selectAll(".OSG")
         ...
         .attr("y", function(d) {
            ...
            return chart_base_y+(accordion_bar_height+5)*1-(accordion_bar_height+5) ;
            })
         .attr("height", function(d) {
...
//OM
      var OM = rightSideCharts.selectAll(".OM")
        ...
        OM.append("text")
         ...
         .attr("fill", "gray");
         // zzcharttext_y.push(0);
        tmpy=chart_base_y+(accordion_bar_height+5)*2-d3.max(occupationmarried.number);
        var y = d3.scaleLinear()
        .domain([0, d3.max(occupationmarried.number)])
        .range([d3.max(occupationmarried.number), 0]);
...
//Oblack
      var Oblack = rightSideCharts.selectAll(".Oblack")
         ...
         .attr("fill", "gray");
         // zzcharttext_y.push(0);
        tmpy=chart_base_y+(accordion_bar_height+5)*3-d3.max(occupationblackPercent.number);
        var y = d3.scaleLinear()
        .domain([0, d3.max(occupationblackPercent.number)])
        .range([d3.max(occupationblackPercent.number), 0]);
...
//Oasian
      var Oasian = rightSideCharts.selectAll(".Oasian")
        ...
        Oasian.append("text")
         ...
         .attr("fill", "gray");
         // zzcharttext_y.push(0);
        tmpy=chart_base_y+(accordion_bar_height+5)*4-d3.max(occupationasianPercent.number);
        var y = d3.scaleLinear()
        .domain([0, d3.max(occupationasianPercent.number)])
        .range([d3.max(occupationasianPercent.number), 0]);
...
//Ohispanic
      var Ohispanic = rightSideCharts.selectAll(".Ohispanic")
        ...
        Ohispanic.append("text")
         ...
         .attr("fill", "gray");
         // zzcharttext_y.push(0);
        tmpy=chart_base_y+(accordion_bar_height+5)*5-d3.max(occupationhispanicPercent.number);
        var y = d3.scaleLinear()
        .domain([0, d3.max(occupationhispanicPercent.number)])
        .range([d3.max(occupationhispanicPercent.number), 0]);
...
//Ofemale
      var Ofemale = rightSideCharts.selectAll(".Ofemale")
        ...
        Ofemale.append("text")
         ...
         .attr("fill", "gray");
         // zzcharttext_y.push(0);
        tmpy=chart_base_y+(accordion_bar_height+5)*6-d3.max(occupationfemalePercent.number);
        var y = d3.scaleLinear()
        .domain([0, d3.max(occupationfemalePercent.number)])
        .range([d3.max(occupationfemalePercent.number), 0]);
...
//OforeignBorn
      var OforeignBorn = rightSideCharts.selectAll(".OforeignBorn")
        ...
        OforeignBorn.append("text")
         ...
         .attr("fill", "gray");
         // zzcharttext_y.push(0);
        tmpy=chart_base_y+(accordion_bar_height+5)*7-d3.max(occupationforeignBornPercent.number);
        var y = d3.scaleLinear()
        .domain([0, d3.max(occupationforeignBornPercent.number)])
        .range([d3.max(occupationforeignBornPercent.number), 0]);
...
//OaverageHoursOfWorkOrWeek
      var OaverageHoursOfWorkOrWeek = rightSideCharts.selectAll(".OaverageHoursOfWorkOrWeek")
        ...
        tmpy=chart_base_y+(accordion_bar_height+5)*8-d3.max(occupationaverageHoursOfWorkOrWeek.number);
        var y = d3.scaleLinear()
        .domain([0, d3.max(occupationaverageHoursOfWorkOrWeek.number)])
        .range([d3.max(occupationaverageHoursOfWorkOrWeek.number), 0]);
