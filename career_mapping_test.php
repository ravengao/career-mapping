         ...
         if ($(bar).hasClass("active"))
          {
            if( chart_class_name[index] != "")
            {
              ...
              d3.selectAll(chart_class_name[index]).select("line").attr("visibility","hidden");
            }
          ...
          else
          {
            if( chart_class_name[index] != "")
            {
              ...
              d3.selectAll(chart_class_name[index]).select("line").attr("visibility","visible");
            }
...
while($rows = mysqli_fetch_assoc($result))
  ...
  <?php 
  /* extract occupation character requirement*/
  $sql ="select occupation, occupationGroup, observations, verbalSkill, quantitativeSkill, reasoningSkill, femalePercent, salary10thPercentile, salary25thPercentile, salaryMedian, salary75thPercentile, salary90thPercentile, description from  OccupationCha042016 group by occupationGroup,occupation";//OccupationCha042016
  $result = $link->query($sql);
  if ($result->num_rows <= 0) {
       echo "0 results";
     }
...
<!--  extract mean occupation character requirement -->
  <?php 
  /* extract occupation character requirement*/
  $sql ="select occupation, occupationGroup, observations, verbalSkill, quantitativeSkill, reasoningSkill, femalePercent, sum(salary10thPercentile*observations)/sum(observations) as salary10th, sum(salary25thPercentile*observations)/sum(observations) as salary25th, sum(salaryMedian*observations)/sum(observations) as salary50th, sum(salary75thPercentile*observations)/sum(observations) as salary75th, sum(salary90thPercentile*observations)/sum(observations) as salary90th, description from  OccupationCha042016 group by occupationGroup";//OccupationCha042016
  $result = $link->query($sql);
  if ($result->num_rows <= 0) {
       echo "0 results";
     }
...
//Occupation Salary
  ...
  .attr("class","occupationSalarybar");
      ...
      occupationSalarybar.append("rect")
          ...
          .attr("y", function(d,i) {
            if(i<13) return chart_base_y-40*1- (d.salary75 * 0.002)+50;
            else if(i>=13&&i<26) return chart_base_y-40*1- (d.salary90 * 0.002)+50;
            else if(i>=26&&i<39) return chart_base_y-40*1- (d.salary50 * 0.002)+50;
            else if(i>=39&&i<52) return chart_base_y-40*1- (d.salary25 * 0.002)+50;
          })
          .attr("width", function(d, i) { 
          ...
          if(i<13)return color[i];
          else if(i>=13&&i<26) return "black";
          else if(i>=26&&i<39) return "black";
          else if(i>=39&&i<52) return "black";
          }) 
          .append("title")
          .text(function(d,i) {
  ...
  console.log(subSalarybarlength)
      ...
      suboccupationSalarybar.append("rect")
          ...
          .attr("y", function(d,i) {
            if(i<subSalarybarlength) return chart_base_y-40*1- (d.salary75 * 0.002)+50;
            else if(i>=subSalarybarlength&&i<subSalarybarlength*2) return chart_base_y-40*1- (d.salary90 * 0.002)+50;
            else if(i>=subSalarybarlength*2&&i<subSalarybarlength*3) return chart_base_y-40*1- (d.salary50 * 0.002)+50;
            else if(i>=subSalarybarlength*3&&i<subSalarybarlength*4) return chart_base_y-40*1- (d.salary25 * 0.002)+50;
          })
          .attr("width", function(d, i) { 
            ...
            else if(i>=subSalarybarlength*3&&i<subSalarybarlength*4) return 40;
          })
          .attr("height", function(d,i) {
          ...
          else if(i>=subSalarybarlength&&i<subSalarybarlength*3) return "black";
        ...
        .selectAll("rect[id=occupationSalarybarid"+1+"]")
        .style("fill", "orange");
